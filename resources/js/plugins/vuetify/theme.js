...
const theme = {
  ...
  themes: {
    light: {
      dark: false,
      colors: {
        'primary':  '#ffcb05', //localStorage.getItem(`${themeConfig.app.title}-lightThemePrimaryColor`) || '#7367F0', 
        'second': '#082873',
        'on-primary': '#fff',
        'secondary': '#A8AAAE',
        'on-secondary': '#fff',
    ...
    dark: {
      dark: true,
      colors: {
        'primary': '#ffcb05', //localStorage.getItem(`${themeConfig.app.title}-darkThemePrimaryColor`) || '#7367F0', 
        'second': '#fff',
        'on-primary': '#fff',
        'secondary': '#A8AAAE',
        'on-secondary': '#fff',
